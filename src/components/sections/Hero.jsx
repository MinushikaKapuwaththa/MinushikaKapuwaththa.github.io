    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12"> {/* Improved responsive padding */}
        ...
        >
          <a
            href="#about"
            className="animate-bounce w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-white dark:bg-gray-800 rounded-full shadow-xl transition-colors duration-300 group border border-gray-300 dark:border-gray-600"
